...
export default function Login() {
    ...
    return (
        <div className="min-h-screen -my-16 -mx-4 md:-ml-[30%] md:-mr-[4%] sm:-mt-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 flex items-center justify-center px-8 sm:px-4 font-sans">
